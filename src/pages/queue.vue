<template>
  <div class="container">
    <div>
      <h1 class="text-2xl text-gray-700 py-4">分析キュー</h1>
    </div>
    <div class="records">
      <div class="mx-auto py-2 px-1">
        <div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative" style="height: 100%;">
          <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
            ...
            <tbody>
              <tr v-for="record in queue" :key="record.id">
...
export default {
  ...
  data() {
    return {
      flashMessage: '',
      headings: ['createdAt', 'twitterId', 'edit']
    }
  },
  computed: {
    queue() {
      return this.$store.state.userAnalyzeQueue
    }
  },
  methods: {
    show() {
